...
declare const measurableLoadAndParseTerraformFiles: (pathToScan: string, parsedFiles: import("./types").IacFileParsed[], failedFiles: import("./types").IacFileParseFailure[], maxDepth?: number | undefined) => Promise<{
    allParsedFiles: import("./types").IacFileParsed[];
    allFailedFiles: import("./types").IacFileParseFailure[];
}>;
